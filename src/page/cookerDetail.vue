<template>
  <div id='cookerDetail'>
    ...
    <div class="detailhead">
      ...
      <p>等级：<span v-if="message.grade>0">LV{{message.grade|grade}}</span><span v-else>LV0</span> &emsp;服务费：<span v-if="message.service>0">{{message.service}}</span><span v-else>无</span></p>
