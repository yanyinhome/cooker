<template>
  <div id='cookerDetail'>
    ...
    <div class="detailhead">
      ...
      <p>等级：<span v-if="message.grade>0">{{message.grade|grade}}</span><span v-else>无等级</span> &emsp;服务费：<span v-if="message.service>0">{{message.service}}</span><span v-else>无</span></p>
